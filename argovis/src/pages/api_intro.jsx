			...
			<>
				...
				<div className='row'>
					<div className='col-12 aboutBlock'>
						...
						<p>Argovis provides an API that indexes and distributes numerous oceanographic datasets with detailed query parameters, enabling you to search and download only and exactly data of interest. Here we'll tour some of the standard usage patterns enabled by Argovis.</p>
						...
						<ul>
							<li>Visit <a href='https://argovisbeta02.colorado.edu/' target="_blank" rel="noreferrer">https://argovisbeta02.colorado.edu/api/</a></li>
						...
						<ul>
							...
							<ul>
								<li>Roemmich-Gilson total temperature, <pre style={{'display':'inline'}}>/grids/temperature-rg</pre></li>
								<li>Roemmich-Gilson total salinity, <pre style={{'display':'inline'}}>/grids/salinity-rg</pre></li>
								<li>ocean heat content, <pre style={{'display':'inline'}}>/grids/ohc-kg</pre></li>
							</ul>
						</ul>
						...
						<p>Argovis' API documentation is found at <a href='https://argovisbeta01.colorado.edu/api/docs/' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/docs/</a>. These docs are split into several categories; what follows applies to all categories not marked experimental; the experimental categories are under development and may change or be removed at any time.</p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100</a></p>
						...
						<p>All data documents bear a <pre style={{'display':'inline'}}>metadata</pre> key, which is a pointer to the appropriate metadata document to find out more about this measurement. Let's fetch that document for this first profile by querying the <pre style={{'display':'inline'}}>argo/meta</pre> route for a doument with an id that matches a given metadata pointer:</p>
						<p><a href='https://argovisbeta01.colorado.edu/api/argo/meta?id=4901283_m0' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo/meta?id=4901283_m0</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?platform=4901283' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?platform=4901283</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo/vocabulary?parameter=platform' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo/vocabulary?parameter=platform</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature</a></p>
						<p>We see the returned profile now has a <pre style={{'display':'inline'}}>data</pre> key, and that key holds a list with one entry for each level. By default, each of those per-level entries is a dictionary with the information we requested, in this case <pre style={{'display':'inline'}}>temperature</pre>, and also <pre style={{'display':'inline'}}>pressure</pre>, whether we requested it or not, as pressure information is crucial for contextualizing all other measurements.</p>
						<h5>Downloading with minification</h5>
						<p>While the per-level dictionaries are easy to read, they are very inefficient in terms of bandwidth, especially for profiles with many levels. We can use a compression option to get faster downloads:</p>
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature&compression=array</a></p>
						<p>The <pre style={{'display':'inline'}}>data</pre> key still contains a list with one entry per level, but those entries are now lists with the appropriate numbers packed in them, without the redundant key names repeated every time. In order to tell which number is which, look at the <pre style={{'display':'inline'}}>data_keys</pre> property, and find the <pre style={{'display':'inline'}}>units</pre> similarly.</p>
						<p><b>Always use compression=array</b>: this setting can dramatically reduce your download times for Argovis data, and it doesn't cause any data losses as it's really just a minification, rather than a true compression. Once comfortable with the format, consider using this option for all data requests.</p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=all&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=all&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature,chla&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?id=4901283_003&data=temperature,chla&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100&data=temperature,chla&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100&data=temperature,chla&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100&data=doxy&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2011-05-01T00:00:00Z&endDate=2011-06-01T00:00:00Z&center=-22.5,0&radius=100&data=doxy&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=temperature,~doxy&compression=array' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=temperature,~doxy&compression=array</a></p>
						...
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy,except-data-values' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy,except-data-values</a></p>
						<p>If we want an even more minimal response, we can use the <pre style={{'display':'inline'}}>compression=minimal</pre> option:</p>
						<p><a href='https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy&compression=minimal' target="_blank" rel="noreferrer">https://argovisbeta01.colorado.edu/api/argo?startDate=2017-08-01T00:00:00Z&endDate=2017-09-01T00:00:00Z&polygon=[[-150,-30],[-155,-30],[-155,-35],[-150,-35],[-150,-30]]&data=doxy&compression=minimal</a></p>
